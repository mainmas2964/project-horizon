...
import { invisibility_scroll, stinger_weapon, nectar_collector, robosphere, builder_wand } from "./items.js"
export function itemCustomComponent(data) {
    ...
    data.itemComponentRegistry.registerCustomComponent("horizon:nectar_collector", nectar_collector)

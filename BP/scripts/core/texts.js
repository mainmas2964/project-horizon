...
abilitiesLoc = {
    ...
    "ru": {
        ...
        "drone_station_t1": {
            ...
            description: "За 12 редстоуна позволяет заспавнить не более 2 гибридных паукоботов Т1\nПри спавне третьего паукобота, самый старый паукобот исчезает\nПозволяет ремонтировать союзных юнитов роботов"
        }
    }
}
classLoc = {
    ...
    "ru": {
        ...
        "mechanist": {
            name: "Механист",
            description: `Механист - инженерный класс, который может наделать шуму даже не находясь на поле боя!\n[ Оссобености ]\nВы получаете больше редстоуна с редстоун руды\n+30 процентов к прочности паукомин\n[ Мобильный верстак Т2 ]\nРобосферы\nКомпоненты для крафта\nИндустриальное оборудование (необходим Utilitycraft)\n[ Доступные способности ]\nДрон-станция Т1\n${abilitiesLoc["ru"]["drone_station_t1"].description}1`
        },
        "builder": {
            name: "Строитель",
            description: "Строитель - класс который любит строить большие здания\n[ Строительный посох ]\nпри выборе класса у вас появляеться строительный посох\nПри использований посоха на любом блоке он попадает в зону выделения\nпри созданий второй то"
        }
    }
}
